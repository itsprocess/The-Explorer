...
export async function occurrenceText(c:CellContext,setting:unknown):Promise<OccurrenceText|undefined>{
 ...
 return remember(namespace()+'occurrence-text-v3:'+c.x+':'+c.y,'occurrence',async()=>{
