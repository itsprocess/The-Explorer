...
export const queueCapacity=(lane:string,priority:number)=>lane==='image'?(priority>=10?configQueue.imageConcurrency:configQueue.backgroundImageConcurrency):(priority>=10?configQueue.textConcurrency:configQueue.backgroundTextConcurrency);
