...
export const originBrief='This is the unique origin (0,0), the safe place of first arrival and return after death. Give it a short distinctive proper name, never simply Home. Make it feel unmistakably like a protected, almost sacred sanctuary of beginnings and return, with a distinctive AI-authored gathering or arrival landmark and clear routes launching into the world. Carry that identity into visual_brief; integrate local terrain and enclosure. Never imply an active teleport encounter, relic reward or faction ownership. Convey its use with one concrete feature and at most one sentence of local history. Characters retain identity across death. The supplied exits all exist. Safety overrides all other layers.';
