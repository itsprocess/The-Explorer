...
export function endLife(original:Character){
 ...
 const c=structuredClone(original);c.alive=false;c.deaths++;delete c.pendingOption;delete c.pendingTransport;c.optionConsumed=[];const lost=deathTraits(c.traits??[]);c.traits=lost.traits;
