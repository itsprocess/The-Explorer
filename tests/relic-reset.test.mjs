...
test('relic world reset preserves credentials and sessions while clearing all progress',()=>{
 ...
 db.exec(readFileSync(new URL('../drizzle/0023_reset_relics.sql',import.meta.url),'utf8'));
