...
- Never reset a world merely for testing or publishing. An explicitly requested world wipe preserves accounts, passwords, sessions and defining traits; reset world content and progress only. Never introduce account-deletion controls.
