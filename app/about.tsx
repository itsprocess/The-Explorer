...
export default function About(){
 ...
 <section><h3><Sparkles aria-hidden="true" size={19}/> Meet the unexpected</h3><p>Choices pause travel until you answer. Your defining trait, possessions, statuses and affiliation standings can shape the outcome. Discover relics, earn badges, and leave a story others may find.</p></section>
 ...
 <section><h3><Heart aria-hidden="true" size={19}/> Begin again</h3><p>Death ends a life, not your history. Return to the sanctuary with your defining trait, badges, standings and lifetime records intact. Temporary possessions and statuses are lost. If stranded, choose “Give up this life” from your profile.</p></section>
