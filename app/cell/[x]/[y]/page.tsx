...
export default async function CellPage({params}:{params:Promise<{x:string;y:string}>}){
 ...
 return <main className="public-page"><a href={appPath('/')}>Return to game</a><p className="view-only">Location record · View only. Viewing this page does not move your character.</p><h1>{cell.scene.title}</h1><div className="coordinates">{x}, {y}</div>
