...
export default function NeighborPreloader({x,y,connections}:{x:number;y:number;connections:Record<string,boolean>;imageReady?:boolean}){
 ...
 useEffect(()=>{
  ...
  for(const direction of exits.split(',').filter(Boolean)){
