export default function ProgressStats({character:c,badges}:{character:any;badges:number}){
 return <div className="stats">
  <div><span>Distance traveled · this life</span><strong>{(c.distanceLife??0).toFixed(1)}</strong></div>
  <div><span>Distance traveled · total</span><strong>{(c.distanceTotal??0).toFixed(1)}</strong></div>
