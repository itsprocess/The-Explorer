...
export function useEventFeedback(){
 ...
 return {unlock,show,popup,soundButton:<button type="button" aria-pressed={muted} aria-label={muted?'Unmute event sounds':'Mute event sounds'} onClick={toggle}>{muted?'Sound off':'Sound on'}</button>};
}
